...
Создает исполняемый файл .app из main.py
"""
import os
import subprocess
import sys
...
def build_macos():
    ...
    main_script = "main.py"
    icon_file = None  # Можно добавить .icns файл если есть
    ...
    try:
        ...
        print(f"\n✅ Сборка завершена!")
        print(f"📁 Исполняемый файл: dist/{app_name}")
        print(f"💡 Для создания .app используйте:")
        print(f"   hdiutil create -volname \"{app_name}\" -srcfolder dist/{app_name} -ov -format UDZO dist/{app_name}.dmg")
